...
HD_PWD='C:/Users/colte/Documents/FIU/Classes/EEL4740/Final_Project/project_final/project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_final.tcl -notrace
